...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{bert_like.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{deep_fusion.png}
