...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|cc|cc|}
        ...
        \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Concept}}
                          & \multicolumn{2}{c|}{\shortstack{\textbf{Modified}                                                                                                      \\\textbf{Network}}}
                          & \multicolumn{2}{c|}{\shortstack{\textbf{Original}                                                                                                      \\\textbf{Network}}}                                                                                                         \\ \cline{3-6}
                          &                                                         & \multicolumn{1}{c|}{\textbf{+ve}}                       & \textbf{-ve}
                          & \multicolumn{1}{c|}{\textbf{+ve}}                       & \textbf{-ve}                                                                                 \\ \hline

        \multirow{7}{*}{\rotatebox{90}{\scriptsize \textbf{No weighting}}}
                          & $\geq$ C1                                               & \multicolumn{1}{c|}{$\cellcolor{red!15}0_{\pm 0}$}      & $100_{\pm 0}$
                          & \multicolumn{1}{c|}{$\cellcolor{red!15}0_{\pm 0}$}      & $100_{\pm 0}$                                                                                \\

                          & $\geq$ B2                                               & \multicolumn{1}{c|}{$\cellcolor{red!15}56.1_{\pm 0.2}$} & $95.2_{\pm 0.0}$
                          & \multicolumn{1}{c|}{$\cellcolor{red!15}48.9_{\pm 1.7}$} & $95.4_{\pm 0.1}$                                                                             \\

                          & $\leq$ A2                                               & \multicolumn{1}{c|}{$\cellcolor{red!15}57.3_{\pm 0.5}$} & $93.9_{\pm 0.1}$
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|cc|cc|}
        \hline
        \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Concept}} & \multicolumn{2}{c|}{\shortstack{\textbf{Modified}                                                                                                                                                   \\\textbf{(DNN)}}}              & \multicolumn{2}{c|}{\shortstack{\textbf{Original}                                                                                                                                                   \\\textbf{(DDN)}}}                                                                                                    \\ \cline{3-6}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|cc|cc|}
        \hline
        \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Concept}}
                          & \multicolumn{2}{c|}{\textbf{\shortstack{Modified                                                                                                       \\ (ReLU)}}}
                          & \multicolumn{2}{c|}{\textbf{\shortstack{Original                                                                                                       \\ (LReLU)}}} \\ \cline{3-6}
                          &                                                         & \multicolumn{1}{c|}{\textbf{+ve}}                       & \textbf{-ve}
                          & \multicolumn{1}{c|}{\textbf{+ve}}                       & \textbf{-ve}                                                                                 \\ \hline
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=0.48\linewidth]{ReLU-like/ReLU_bias_part1_input_layer.png}
        \hfill
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=0.48\linewidth]{ReLU-like/LReLU_bias_part1_input_layer.png}
        \hfill
...
The accuracy of the CAVs extracted from the modified text-based model is shown in Table \ref{tab:CAV_accuracy_lrelu}. The results show that the CAVs from the modified LReLU model have nearly identical performance as the original LReLU model. Hence, it could be used to measure bias reliably.
\begin{table}[H]
    \centering
    \begin{tabular}{|c|c|cc|cc|}
        \hline
        \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Concept}}
                          & \multicolumn{2}{c|}{\shortstack{\textbf{Modified}                                                                                                                                                                                                       \\\textbf{(LReLU)}}}
                          & \multicolumn{2}{c|}{\shortstack{\textbf{Original}                                                                                                                                                                                                       \\\textbf{(ReLU)}}} \\ \cline{3-6}
                          &
                          & \multicolumn{1}{c|}{\textbf{+ve}}                 & \textbf{-ve}
                          & \multicolumn{1}{c|}{\textbf{+ve}}                 & \textbf{-ve}                                                                                                                                                                                        \\ \hline
        \multirow{7}{*}{\rotatebox{90}{\scriptsize \textbf{No weighting}}}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=0.48\linewidth]{LReLU-like/lrelu_bias_part1_layer1.png}
        \hfill
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=0.48\linewidth]{LReLU-like/relu_bias_part1_layer1.png}
        \hfill
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|cc|cc|}
        \hline
        \multirow{2}{*}{} & \multirow{2}{*}{\textbf{Concept}} & \multicolumn{2}{c|}{\shortstack{\textbf{Modified}                                                                                                                                                   \\\textbf{(With Feature)}}} & \multicolumn{2}{c|}{\shortstack{\textbf{Original}\\\textbf{(No Feature)}}}                                                                                              \\ \cline{3-6}
                          &                                   & \multicolumn{1}{c|}{\textbf{+ve}}                         & \textbf{-ve}                         & \multicolumn{1}{c|}{\textbf{+ve}}                         & \textbf{-ve}                         \\ \hline
        \multirow{7}{*}{\rotatebox{90}{\scriptsize \textbf{No weighting}}}
                          & $\geq$ C1                         & \multicolumn{1}{c|}{$\cellcolor{red!15}{0_{\pm 0}}$}      & $100_{\pm 0}$                        & \multicolumn{1}{c|}{$\cellcolor{red!15}{0_{\pm 0}}$}      & $100_{\pm 0}$                        \\
                          & $\geq$ B2                         & \multicolumn{1}{c|}{$\cellcolor{red!15}{52.0_{\pm 0.3}}$} & $95.5_{\pm 0.0}$                     & \multicolumn{1}{c|}{$\cellcolor{red!15}{50.6_{\pm 2.0}}$} & $95.3_{\pm 0.2}$                     \\
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=0.48\linewidth]{text_with_feature_none.png}
        \hfill
